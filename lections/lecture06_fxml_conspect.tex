...
\textbf{Материалы:} Готовый шаблон проекта на Gradle (GitHub/zip), код с встроенными комментариями.

\textbf{Распределение времени:} 80 мин.

\section{1. Введение и настройка проекта (0--10 мин)}
...
\section{2. База JavaFX: Stage, Scene, граф и FXML (10--30 мин)}
...
\section{4. Базовые Controls в FXML (50--60 мин)}
...
\section{5. Events и создание приложения в FXML (60--80 мин)}
